...
function Home() {
   ...
   console.log("The items are:",itemsArray);
     ...
                    <option value="NS">NS Restaurant</option>
              ...
              <br/>
              <br/>
                <input type="checkbox" id="Item3" name="Item3" value="Chicken Roll" onChange={handleselect}/>
                <label htmlFor="Item3"> Chicken Roll</label><br/>
                <input type="checkbox" id="Item1" name="Item1" value="Burger" onChange={handleselect}/>
                <label htmlFor="Item1"> Burger</label><br/>
                <input type="checkbox" id="Item2" name="Item2" value="Pizza" onChange={handleselect}/>
                <label htmlFor="Item2"> Pizza</label><br/>        
            </form></>): <div>
